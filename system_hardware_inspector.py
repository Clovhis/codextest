...
def create_openai_client() -> AzureOpenAI:
    """Create AzureOpenAI client from encrypted credentials."""
    api_key, api_version, endpoint = load_credentials()
...
class AIAnalysisThread(QtCore.QThread):
    ...
    def __init__(self, hardware_hash: str, client: AzureOpenAI, parent: QtCore.QObject | None = None):
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def start_ai_analysis(self) -> None:
        ...
        self.thread = AIAnalysisThread(self.hardware_hash, client)
